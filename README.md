[![pu32-toolchain](https://github.com/fontamsoc/rvpu/actions/workflows/release.yml/badge.svg)](https://github.com/fontamsoc/rvpu/actions/workflows/release.yml)

RISC-V RTOS-enabled multi-core SoC supporting Wishbone4 peripherals.

CPU is a single-issue in-order 4 stages pipeline with branch-prediction.
...
## Build toolchain (or [download prebuilt](https://github.com/fontamsoc/rvpu/releases/latest/download/rvpu-toolchain-linux-x64.tar.xz))
